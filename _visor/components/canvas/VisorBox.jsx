...
export default class VisorBox extends Component {
    ...
    render() {
        ...
        let content = toolbar.config.flavor === "react" ? (
            <div style={style} {...attrs} className={"boxStyle " + classNames} ref={"content"}>{Ediphy.Visor.Plugins[toolbar.pluginId].getRenderTemplate(toolbar.state, box.id, props)}</div>
        ) : (

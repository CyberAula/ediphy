...
var DaliScorm = {
    ...
    testXML: function(title, sections){
      ...
      organizations.setAttribute("default","default_org");

      var organization = doc.createElement("organization");
      organization.setAttribute("identifier","default_org");
      ...
      item_org.setAttribute("identifier", "item_1");
      item_org.setAttribute("identifierref","resource_1");

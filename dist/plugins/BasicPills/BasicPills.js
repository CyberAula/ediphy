               ...
               // if(i==0){
                if(auxTitles[i]){
                    ...
                    if(auxTexts[i]){
                        ...
                        <div class="col-xs-12 col-sm-6">Color: <input type="color" name="favcolor" id="color+'+i+'" value="#ff0000"> </div>\n\
        ...
        getRenderTemplate: function(state){
            ...
            for(var i = 0; i < number ; i++){
                if(i==0){
                    //auxTitles.push('title'+i); 
                    //auxTexts.push('text'+i); 
                    auxNavPills += '<div style="padding:0%" class="col-xs-'+ ancho+'"><li style="padding:0%; background-color: red;" class="active" onClick="BasicPills.handleSelect('+i+')">'+auxTitles[i]+'</li></div>';
                    auxTextsPills += '<div id="Text'+i+'Pill'+n+'"><p>'+auxTexts[i].toString()+'</p></div>';
                }else{
                    //auxTitles.push('title'+i); 
                    //auxTexts.push('text'+i); 
                    auxNavPills +=  '<div class="col-xs-'+ancho+'"><li style="padding:0%"  onClick="BasicPills.handleSelect('+i+')">'+auxTitles[i]+'</li></div>';
            ...
            //state.texts
             ...
             /* <div style="padding:0%" class="col-xs-6">\n\
                         ...
                         <div class="col-xs-6">\n\
                            ...
                            <div class="row" style="border: red;border-style: solid;border-radius: 0.5em;margin-top: 3%;" >'+auxTextsPills+'</div>\n\
                            </div>'

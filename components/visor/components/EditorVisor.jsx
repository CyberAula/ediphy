...
import DaliCanvasVisor from './DaliCanvasVisor';

require('es6-promise').polyfill();
require('./../../sass/style.scss');
require('./../../core/visor_entrypoint');

export default class DaliVisor extends Component {
    render() {
...
/* jshint ignore:start */
ReactDOM.render((<DaliVisor />), document.getElementById('root'));
/* jshint ignore:end */

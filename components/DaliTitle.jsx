...
export default class DaliTitle extends Component {
    render() {
        ...
        let icons = {'reduced':'fa fa-minus','expanded':'fa fa-plus','hidden': 'fa fa-eye'}
        ...
        if (currentstatus != 'hidden'){
                    ...
                    <div className="caja">
                        <div className="cab"> 
                            ...
                            <div className="cabtabla_lapiz">            
                                <Button style={{border: 0, backgroundColor: '#eee', visibility: (hideButton)? 'hidden' : 'visible', position: 'absolute', top:20, right:75}} onClick={() => {
                                     this.props.titleModeToggled(this.props.navItemId, nextstatus);
                                 }}>
                                     <i className={currenticon /*this.props.isReduced ? "fa fa-plus" : "fa fa-minus"*/}></i>
                                </Button>
            ...
            return (
                <div className="caja">
                    <div className="cab"> 
                        <div className="cabtabla_lapiz">          
                            <Button style={{border: 0, backgroundColor: '#eee', visibility: (hideButton)? 'hidden' : 'visible', position: 'absolute', top:30, right:105}} onClick={() => {
                                         this.props.titleModeToggled(this.props.navItemId, nextstatus);
                                     }}>
                                 <i className={currenticon /*this.props.isReduced ? "fa fa-plus" : "fa fa-minus"*/}></i>
                            </Button>

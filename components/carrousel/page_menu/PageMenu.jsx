            ...
            <Dropdown role="menuitem"
                ...
                <Dropdown.Menu className="pageMenu" id="bottomMenu" onSelect={() => null}>
                    ...
                    <MenuItem eventKey="1" onClick={e =>{
                           ...
                           this.props.onNavItemAdded(idnuevo,  i18n.t("page"), this.calculateParent().id , [], this.calculateParent().level + 1, PAGE_TYPES.DOCUMENT, this.calculateNewPosition(), 'expanded');
                    ...
                    <MenuItem eventKey="2" onClick={e => {
                           this.props.onNavItemAdded(ID_PREFIX_PAGE + Date.now(),  i18n.t("slide"), this.calculateParent().id , [], this.calculateParent().level + 1,  PAGE_TYPES.SLIDE, this.calculatePosition(), 'hidden')
                        }}>

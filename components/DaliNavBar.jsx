    ...
    render() {
        ...
        return (
                <div className="navBar">
                    <Col id="iconBar" mdOffset={2} xsOffset={2}>
                        ...
                        <button className={ this.props.hideTab == 'show' && this.props.categoria == 'multimedia' ? 'navButtonPlug active':'navButtonPlug' } title='Multimedia' disabled={(this.props.navItemsIds.length === 0 ? true : false)} onClick={() => {this.openPlugin('multimedia')}}><i className="fa fa-play fa-1 "></i> <span className="hideonresize">Animaciones</span>  </button>
                        <button className={ this.props.hideTab == 'show' && this.props.categoria == 'animations' ? ' navButtonPlug active':'navButtonPlug' } title='Animations' disabled={(this.props.navItemsIds.length === 0 ? true : false)} onClick={() => {this.openPlugin('animations')}}><i className="fa fa-film fa-1 "></i> <span className="hideonresize">Multimedia</span>  </button>

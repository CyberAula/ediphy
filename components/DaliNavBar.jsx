        ...
        return (
                <div className="navBar">
                     <Col id="iconBar" >
                        ...
                        <button className={ this.props.hideTab == 'show' && this.props.categoria == 'image' ? 'navButtonPlug active':'navButtonPlug' } title='Images' disabled={(this.props.navItemsIds.length === 0 ? true : false)} onClick={() => { this.openPlugin('image')}}><i className="fa fa-photo fa-1 "></i><span className="hideonresize"> Imagen</span>  </button>

let es = {
    translation: {
        ...
        "joyride": {
            'back': 'Atrás',
            'carrousel': 'Completa y ordena tu curso añadiendo más páginas, diapositivas y carpetas. ',
            'close': 'Cerrar',
            'drag': 'Elige el contenido que necesitas, y añádelo arrastrando o haciendo click',
            'index': 'Gestiona tus páginas, diapositivas y vistas contenidas desde el índice. Ah! Un vista contenida se crea al insertar marcas en tus recursos',
            'last': 'Finalizar',
            'manual': 'Si te ha quedado alguna duda, accede al menú de ayuda. Puedes volver ejecutar este paseo o consultar nuestro',
            'manual2': ' manual de usuario',
            'menu': 'Desde el menú puedes importar tus PDFs y todos los recursos que necesites. También desde aquí podrás exportar el curso a formatos estandar y cambiar la configuración global',
            'need_help': "¿Necesitas ayuda para empezar?",
            'next': 'Siguiente',
            'preview': 'Previsualiza tu curso tantas veces como necesites para ver cómo está quedando',
            'skip': 'Saltar',
            'start': 'Si, me vendría bien',
            'toolbar': 'Cambia la configuración de tus documentos y recursos en la barra de propiedades',
        ...
        "marks": {
            ...
            "new_content_label": "Tipo de documento",
            "new_document": "Página",
        ...
        "messages": {
            ...
            "export_to_label": "Elige cómo quieres exportar el curso",

let es = {
    translation: {
        ...
        "joyride": {
            'back': 'Atrás',
            'carrousel': 'Puedes añadir más documentos y diapositivas',
            'close': 'Cerrar',
            'drag': 'Elige el contenido que necesitas, y añádelo arrastrando o haciendo click',
            'last': 'Finalizar',
            'manual': 'Si te han quedado más dudas puedes consultar el ',
            'manual2': ' manual de usuario',
            'menu': 'Desde el menu puedes importar contenido externo a Ediphy y también descargarte lo que has creado',
            'need_help': "¿Necesitas ayuda para empezar?",
            'next': 'Siguiente',
            'preview': '¡No te olvides de previsualizar antes de terminar!',
            'skip': 'Saltar',
            'start': 'Si, me vendría bien',
            'toolbar': 'Puedes editar el contenido creado desde la barra de herramientas lateral',

let en = {
    translation: {
        ...
        "joyride": {
            ...
            'last': 'Finish',
            'manual': 'If you have any doubt, you can access Help menu. You can always run this tour again or consult our ',
            'manual2': ' user manual',
            'menu': 'From the menu, you can import your PDFs and all the resources you need. Also from here you can export the course to standard formats and change the global settings',
            'need_help': "Do you need help to start adding some content?",
            'next': 'Next',
            'preview': 'Preview your course as many times as you need to see how is going on',
            'skip': 'Skip',
            'start': 'Start walkthrough',
            'toolbar': 'You can change the settings of your documents & resources in the toolbar',
            'welcome': 'Welcome to ',

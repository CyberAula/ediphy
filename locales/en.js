let en = {
    translation: {
        ...
        "marks": {
            ...
            "new_content_label": "Document type",
            "new_document": "Page",
            "new_slide": "Slide",
        ...
        "messages": {
            ...
            "export_to_label": "Choose how to export the course",
            ...
            "publish_alert_text": "This action will publish your document in the public repository. Means that everybody can reuse it.",
        ...
        "SCORM Explanation": "A SCORM package is a collection of files which are packaged according to an agreed standard for learning objects. SCORM packages are zip files that can be integrated in any LMS (Learning Management System) that supports the standard (Moodle, Blackboard, …) and that can be used for presenting multimedia content and as assessment tools. Thus, you can integrate this course in Moodle and other LMSs by downloading it as SCORM.",
        "HTML Explanation": "This option exports a .zip package that contains two folders: one with the index.html file of the course, which you can open in any browser, and another with the necessary resources for its correct preview.",

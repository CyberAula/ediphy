let en = {
    translation: {
        ...
        "joyride": {
            'back': 'Back',
            'carrousel': 'You can add more documents and slides',
            'close': 'Close',
            'drag': 'You can drag any type of content from the top ribbon',
            'last': 'Finish',
            'manual': 'If you have any more doubts you can check the ',
            'manual2': ' user manual',
            'menu': 'From the menu you can import external content to Ediphy and download what you\'ve created',
            'next': 'Next',
            'preview': 'Don\'t forget to preview the content before you finish!',
            'skip': 'Skip',
            'start': 'Start walkthrough',
            'toolbar': 'You can edit the content from the toolbar',
            'welcome': 'Welcome to ',

...
export function addBox(parent, id, type, draggable, resizable, content, toolbar){
    return {type: ADD_BOX, payload: {parent, id, type, draggable, resizable, content, toolbar}};
}

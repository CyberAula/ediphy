...
export const DARK_GREEN_GREY = '#425D54';
export const BRAND_GREEN = '#133329';
export const DETAIL_GREEN = '#39B54A';
export const DETAIL_GREEN_TRANSPARENT = 'rgba(57, 181, 74, 0.1)';
...
export const LIGHT_RED_TRANSPARENT = 'rgba(227, 11, 11, 0.1)';

// Orange
export const ADAMS_ORANGE = '#F47920';
export const LIGHT_ORANGE = '#FFF6EC';
...
export const GREY_INSIDE_PANELS = '#545454';
export const GREY_PANEL_HEADINGS = '#1A1A1A';
export const GREY = '#333';

// White
export const DARK_INPUT = '#FFFFFF';

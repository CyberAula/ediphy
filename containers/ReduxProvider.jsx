...
export default class ReduxProvider extends Component {
    constructor(props) {
        ...
        this.initialState = Dali.Config.sections_have_content ? 
            ({present: {
                globalConfig: {title: i18n.t('course_title'), canvasRatio: 16/9, trackProgess: true, age: {min:0, max:100}, context: 'school', rights: "Public Domain", keywords: [], typicalLearningTime:{h:0,m:0,s:0},  version:'1.0.0', status: 'draft', structure: 'linear', difficulty:'easy'},
                displayMode: "list",
                imagesUploaded:[],
            ...
            ({present:{
                 globalConfig: {title: i18n.t('course_title'), canvasRatio: 16/9, trackProgess: true, age: {min:0, max:100}, context: 'school', keywords: [], rights: "Public Domain", status: 'draft', structure: 'linear', version:'1.0.0', typicalLearningTime:{h:0,m:0,s:0}, difficulty:'easy'},
                 imagesUploaded:[],

...
import {addNavItem, selectNavItem, expandNavItem, removeNavItem, reorderNavItem, toggleNavItem, updateNavItemExtraFiles,
    ...
    changeDisplayMode, updateToolbar, updateOnCreationToolbar, collapseToolbar,
        ...
        return (
            ...
            <Grid id="app" fluid={true} style={{height: '100%'}}>
                ...
                <PluginToolbar top={(60+ribbonHeight)+'px'}
                               ...
                               onCreationToolbarUpdated={(id, tab, accordion, name, value) => this.dispatchAndSetState(updateOnCreationToolbar(id, tab, accordion, name, value))}

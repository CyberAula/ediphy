...
class GlobalConfig extends Component {
  state = {
      ...
      disableSelection: this.props.globalConfig.disableSelection || false,
      disabeFullScreen: this.props.globalConfig.disabeFullScreen || false,
  ...
  render() {
    ...
    cancel = () => {
        this.setState({
            ...
            hideGlobalScore: this.props.globalConfig.hideGlobalScore || false,
            disableSelection: this.props.disableSelection || false,
            disabeFullScreen: this.props.disabeFullScreen || false,
            minTimeProgress: this.props.globalConfig.minTimeProgress || 3,
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (!this.props.reactUI.showGlobalConfig && nextProps.reactUI.showGlobalConfig) {
            this.setState({
                ...
                disableSelection: nextGlobalConfig.disableSelection || false,
                disabeFullScreen: nextGlobalConfig.disabeFullScreen || false,

...
export function Polygons() {
    return {
                    ...
                    accordions: {
                          polygonstyle: {
                              ...
                              buttons: {
                                  ...
                                  polygonBorderStyle: {
                                      __name: Ediphy.i18n.t('Polygons.polygonBorderStyle'),
                                      type: 'select',
                                      value: state.polygonBorderStyle,
        ...
        getRenderTemplate: function(state,props) {
            // let shapeColor = state.shapeColor.color || PRIMARY_BLUE;
            return(
            <Poly sides={state.nSides} size={40} cx={50} cy={50} r={50}

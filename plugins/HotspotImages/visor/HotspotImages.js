    ...
    return {
        getRenderTemplate: function(state, props) {
            ...
            let markElements = Object.keys(marks).map((e) =>{
                ...
                let width = markType === "image" ? String(marks[e].content.imageDimensions.width) + "%" : "auto";
                ...
                return(
                    <div key={e} style={{ position: 'absolute', transform: "translate(-50%, -50%)", top: position[0] + "%", left: position[1] + "%", width: width, height: "auto" }}>
                        <Mark
                            markType={markType}
                            content={content}
                            isImage

...
describe('# single_contained_views_by_id reducer ******************************************************************* TODO :)', ()=>{
    ...
    describe('handle PASTE_BOX', () => {
        test('If box pasted to cv slide', () => {
            ...
            let newState = {
                "cv-1511252975055":
            { "id": "cv-1511252975055", "parent": { "bo-1511252970033": ["rm-1511252975055"] }, "name": "prueba", "boxes": [ids.id], "type": "slide", "extraFiles": {}, "header": { "elementContent": { "documentTitle": "prueba", "documentSubTitle": "", "numPage": "" }, "display": { "courseTitle": "hidden", "documentTitle": "expanded", "documentSubTitle": "hidden", "breadcrumb": "hidden", "pageNumber": "hidden" } } } };
        ...
        test('If box pasted to cv slide with mark to navItem', () => {
            ...
            let newState = {
                "cv-1511252975055":
            { "id": "cv-1511252975055", "parent": { "bo-1511252970033": ["rm-1511252975055"], "bo-15118685651356": ["rm-1511252975055_1"] }, "name": "prueba", "boxes": [ids.id], "type": "slide", "extraFiles": {}, "header": { "elementContent": { "documentTitle": "prueba", "documentSubTitle": "", "numPage": "" }, "display": { "courseTitle": "hidden", "documentTitle": "expanded", "documentSubTitle": "hidden", "breadcrumb": "hidden", "pageNumber": "hidden" } } } };
